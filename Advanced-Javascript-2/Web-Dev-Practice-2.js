...
//create div with container class and style to visulaize
          ...
          var darkModeIsActive = false;
            ...
            clickBtn.addEventListener('click', function() {
              if(darkModeIsActive) {
                ...
                clickBtn.style.cssText = 'padding: 15px; border: none; background-color: black; color: white';
                clickBtn.textContent = 'Enable Dark Mode';
                darkModeIsActive = false;
              } else {
                  document.body.style.backgroundColor = 'black';
                  container.style.cssText = 'background-color: #777; color: white';
                  clickBtn.style.cssText = 'padding: 15px; border: none; background-color: white; color: black';
                  clickBtn.textContent = 'Disable Dark Mode';
